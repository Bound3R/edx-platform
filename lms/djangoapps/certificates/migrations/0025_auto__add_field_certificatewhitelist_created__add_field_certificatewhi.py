...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CertificateWhitelist.free_text'
        db.add_column('certificates_certificatewhitelist', 'free_text',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CertificateWhitelist.free_text'
        db.delete_column('certificates_certificatewhitelist', 'free_text')
    ...
    models = {
        ...
        'certificates.certificatewhitelist': {
            ...
            'free_text': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'certificates.examplecertificate': {
            ...
            'access_key': ('django.db.models.fields.CharField', [], {'default': "'d863d2db83454041ad6777baee3e2ec6'", 'max_length': '255', 'db_index': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2cbe338e000744eeb50fce8ddc1cb2bf'", 'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
