...
class CertificatesPage(PageObject):
    ...
    def add_certificate_exception(self, student, free_text_note):
        ...
        self.get_selector('#free-text-notes').fill(free_text_note)
    ...
    def error_message(self):
        """
        Returns the Error Message in "Certificate Exceptions" section.
        """
        return self.get_selector('div.error-message')
